class DashboardView {
    ...
    slideContactSection() {
        ...
        if (transformProperty === "translateX(-150%)") this.contactSection.style.transform = "translateX(0)";
        else this.contactSection.style.transform = "translateX(-150%)";
    }
    renderChat() {
        if (this.getDashboardWidth() < 1000) this.slideContactSection();
    }
}
const Dashboard = new DashboardView();

//# sourceMappingURL=chats.c86fd82f.js.map
